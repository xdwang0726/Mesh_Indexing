...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 14:39:57 2019
...
from hierachy_analysis import hierachy_eval_parent, hierachy_eval_child, hierachy_analysis
start = time. time()
#### GPU specified ####
...
# top_5_predicted
# distance 1
hierachy5_upper1 = hierachy_eval_parent(test_mesh, top_5_mesh, 1)
print("HP@1_c0_p1:", hierachy5_upper1)
    
hierachy5_lower1 = hierachy_eval_child(test_mesh, top_5_mesh, 1)
print("HP@1_c1_p0:", hierachy5_lower1)

# distance 2
hierachy5_upper2 = hierachy_eval_parent(test_mesh, top_5_mesh, 2)  
print("HP@2_c0_p2:", hierachy5_upper2)

hierachy5_lower2 = hierachy_eval_child(test_mesh, top_5_mesh, 2)
print("HP@2_c2_p0:",hierachy5_lower2)


hierachy5_p1_c2 = hierachy_analysis(test_mesh, top_5_mesh, 2, 1)
print("HP@2_c2_p1:", hierachy5_p1_c2)
  
hierachy5_p2_c1 = hierachy_analysis(test_mesh, top_5_mesh, 1, 2)
print("HP@2_c1_p2:", hierachy5_p2_c1)

print("top_10_predicted")
# top_10_predicted
# distance 1
hierachy10_upper1 = hierachy_eval_parent(test_mesh, top_10_mesh, 1)
print("HP@1_c0_p1:", hierachy10_upper1)
    
hierachy10_lower1 = hierachy_eval_child(test_mesh, top_10_mesh, 1)
print("HP@1_c1_p0:", hierachy10_lower1)

# distance 2
hierachy10_upper2 = hierachy_eval_parent(test_mesh, top_10_mesh, 2)  
print("HP@2_c0_p2:", hierachy10_upper2)

hierachy10_lower2 = hierachy_eval_child(test_mesh, top_10_mesh, 2)
print("HP@2_c2_p0:",hierachy10_lower2)


hierachy10_p1_c2 = hierachy_analysis(test_mesh, top_10_mesh, 2, 1)
print("HP@2_c2_p1:", hierachy10_p1_c2)
  
hierachy10_p2_c1 = hierachy_analysis(test_mesh, top_10_mesh, 1, 2)
print("HP@2_c1_p2:", hierachy10_p2_c1)

print("top_15_predicted")
# top_15_predicted
# distance 1
hierachy15_upper1 = hierachy_eval_parent(test_mesh, top_15_mesh, 1)
print("HP@1_c0_p1:", hierachy15_upper1)
    
hierachy15_lower1 = hierachy_eval_child(test_mesh, top_15_mesh, 1)
print("HP@1_c1_p0:", hierachy15_lower1)

# distance 2
hierachy15_upper2 = hierachy_eval_parent(test_mesh, top_15_mesh, 2)  
print("HP@2_c0_p2:", hierachy15_upper2)

hierachy15_lower2 = hierachy_eval_child(test_mesh, top_15_mesh, 2)
print("HP@2_c2_p0:",hierachy15_lower2)


hierachy15_p1_c2 = hierachy_analysis(test_mesh, top_15_mesh, 2, 1)
print("HP@2_c2_p1:", hierachy15_p1_c2)
  
hierachy15_p2_c1 = hierachy_analysis(test_mesh, top_15_mesh, 1, 2)
print("HP@2_c1_p2:", hierachy15_p2_c1)
print("Finish!")
